...
(function (onsenuiCore) {
    ...
    var MyModelController = (function () {
        ...
        MyModelController.prototype.newAction2 = function () {
            console.log('[onsenuilog] ' + 'MyModelController' + MyModelController.ID + '::newAction2');
            // get selected item
            var newItem = new onsenuiCore.MyModelItem();
            // push selected item
            onsenuiCore.Navigator.pushPage('new-mymodel2.html', { data: { selectedParam: newItem } });
        };
        // //////////////////////////////////////////////
